      ...
      >
        ...
        <div className="p-3 md:p-5 flex-1 flex flex-col">
          <div className="flex justify-between items-start mb-1.5 md:mb-2.5">
            <h3 className="text-sm md:text-[17px] font-extrabold text-slate-900 line-clamp-2 leading-snug group-hover:text-pt-green transition-colors tracking-tight">
              {ad.title}
            </h3>
          </div>

          <div className="flex flex-col gap-1.5 text-slate-400 text-[10px] md:text-xs font-medium mb-3 md:mb-5">
            <div className="flex items-center gap-1.5 text-slate-600">
              <MapPin size={13} className="text-indigo-500 shrink-0 md:w-3.5 md:h-3.5" />
              <span>{ad.city}</span>
            </div>
            <div className="flex items-center gap-1.5 text-slate-500">
              <Tag size={13} className="text-teal-600 shrink-0 md:w-3.5 md:h-3.5" />
          ...
          <div className="flex items-center justify-between mt-auto pt-2 md:pt-4 border-t border-slate-50">
            ...
            {/* WhatsApp Informative Indicator */}
            {ad.category !== 'Imigração' && (
              <div className="flex items-center gap-1 bg-emerald-50 text-emerald-700 px-2.5 py-1 md:py-1.5 rounded-full border border-emerald-100/60 shadow-sm" title="WhatsApp disponível no anúncio">
                ...
                <span className="text-[10px] md:text-xs font-bold leading-none select-none">Contatar</span>
              </div>
            )}
          </div>
        </div>
