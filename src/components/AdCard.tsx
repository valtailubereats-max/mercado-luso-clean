      ...
      >
        ...
        <div className="p-3 md:p-5 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-auto pt-2 md:pt-4 border-t border-slate-50">
            ...
            {ad.category !== 'Imigração' && (
              <div className="flex items-center justify-center bg-emerald-50 text-emerald-700 p-1.5 rounded-full border border-emerald-100/60 shadow-sm" title="WhatsApp disponível no anúncio">
