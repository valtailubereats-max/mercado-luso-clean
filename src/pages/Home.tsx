  ...
  return (
    <div className="space-y-6">
      ...
      <section className="relative -mt-6 md:-mt-8 overflow-hidden shadow-2xl transition-all duration-500 rounded-b-[2rem] md:rounded-b-[3rem]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center py-10 md:py-16 px-6">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-xs md:text-lg font-medium text-white/90 mb-8 tracking-widest uppercase drop-shadow-md">
